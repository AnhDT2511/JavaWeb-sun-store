...
var OpAuthSignUp = function() {
    var e = function() {
        jQuery(".js-validation-signup").validate({
            ...
            rules: {
                "signup-username": { required: !0, minlength: 4 },
...
/* ===== */
function setLabelUsername() {
    var element = document.getElementById('l-username');
...
function setLabelPasswordCf() {
    var element = document.getElementById('l-password-cf');
    element.classList.add("focus-lable");
}